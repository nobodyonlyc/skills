...
|---|---|---|
| **1. New project** | empty / greenfield repo; "build me a …" | Route 1 — new-project intake (BA → per-component SPEC → US backlog → common design). Drives [workflow-bootstrap](../workflow-bootstrap/SKILL.md). *(playbook: F24)* |
