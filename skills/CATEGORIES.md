...
| Group | Prefix | Skills |
|---|---|---|
| **Workflows** — multi-agent orchestrators (entry points) | `workflow-` | workflow-bootstrap, workflow-feature, workflow-bugfix, workflow-prototype, workflow-qa, workflow-release-prep, workflow-review-deep |
