# GEMINI.md — Agent Pointer (Antigravity / Gemini)

> **Single source of truth:** [AGENTS.md](AGENTS.md). Read it first for full instructions.
> This file is a thin pointer so Gemini-based agents (Antigravity, Gemini CLI) discover the project
> guidance; do not duplicate content here — keep `AGENTS.md` canonical.
...
- **Code style** — per [.gemini/settings.json](.gemini/settings.json): Python, Vietnamese comments.
